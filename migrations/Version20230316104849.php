 ...
 */
final class Version20230316104849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tarifer (id INT AUTO_INCREMENT NOT NULL, periode_id INT DEFAULT NULL, tarif DOUBLE PRECISION NOT NULL, INDEX IDX_6904C4FFF384C1CF (periode_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
