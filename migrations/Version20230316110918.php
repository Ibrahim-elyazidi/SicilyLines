 ...
 */
final class Version20230316110918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipement_bateau (id INT AUTO_INCREMENT NOT NULL, equipement_id INT DEFAULT NULL, bateau_id INT DEFAULT NULL, quantite INT NOT NULL, INDEX IDX_F0F14295806F0F5C (equipement_id), INDEX IDX_F0F14295A9706509 (bateau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
